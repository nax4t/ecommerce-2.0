                        ...
                        {product.countInStock > 0 && (
                            <ListGroup.Item>
                                <Row>
                                    <Col>Qty</Col>
                                    <Col>
                                        <Form.Control as='select' value={qty} onChange={(e) => setQty(Number(e.target.value))}>{[...Array(product.countInStock).keys()].map((x) => (
                    ...
                    <ListGroup variant='flush'>
                        ...
                        <ListGroup.Item>
                            ...
                            {userInfo ? (
                                ...
                                <Message variant='success'>Please <Link to='/login'>Sign in</Link> to review the item</Message>
                            )}
                        </ListGroup.Item>
                    </ListGroup>
                </Col>
